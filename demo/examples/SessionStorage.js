...
class SessionStorage extends React.Component {
  ...
  render() {
    return (
      <div>
        <blockquote>
        <h3>Client Session store using sessionStorage persistence</h3>
        ...
        <button type="submit" onClick={this.setUsername}>Add to Session(sessionStorage)</button>

        <br /><br />
        <p>{this.state.sessionUsername}</p>
        <br />

        <button type="submit" disabled={this.state.sessionUsername === ""} onClick={this.clear}>Clear from sessionStorage</button>
        &nbsp;&nbsp;&nbsp;{this.state.message}
        <br /><br />
        ...
        <pre><code>
          ...
          <br />
          class SessionStorage extends React.Component &#123;<br />
            &nbsp;&nbsp;constructor() &#123;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;super(); <br />
            &nbsp;&nbsp;&nbsp;&nbsp;this.state = &#123;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: "",<br />
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;ReactSession.setStoreType("sessionStorage");<br />
            &nbsp;&nbsp;&#125;<br />
            <br />
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Client Session store with sessionStorage persistence&lt;/h3&gt;<br />
            <br />         
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Add a username and display it &nbsp;&lt;Link to="/"&gt;Back&lt;/Link&gt;&lt;/p&gt;<br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="text" name="username" value=&#123;this.state.username&#125; onChange=&#123;this.handleChange&#125; placeholder="Set a username" /&gt;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button type="submit" onClick=&#123;this.setUsername&#125;&gt;Add to Session(sessionStorage)&lt;/button&gt;<br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&#123;this.state.sessionUsername&#125;&lt;/p&gt;<br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button type="submit" disabled=&#123;this.state.sessionUsername === ""&#125; onClick=&#123;this.clear&#125;&gt;Clear from sessionStorage&lt;/button&gt;<br />
